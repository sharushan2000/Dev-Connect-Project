...
from .models import UserProfile ,Project,ContactInformation ,Education,Experience,Geek
...
admin.site.register(Geek) # This line will make the Project model visible on the admin page